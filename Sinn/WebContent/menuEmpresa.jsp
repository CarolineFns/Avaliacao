	...
	<div class="container">
		<jsp:include page="cabecalho.jsp" />
			...
			<div align="center">
				...
				<a href="EmpresaServlet?acao=IrParaTelaInsercao" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Cadastrar</a>
				<a href="EmpresaServlet?acao=Listar" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i> Consultar</a>
			</div>
		</div>
	</div>
</body>
